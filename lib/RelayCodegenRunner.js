...
var RelayCodegenRunner = function () {
    ...
    var _ref3 = (0, _asyncToGenerator3.default)(function* (filePaths) {
      ...
      yield Promise.all(Object.keys(this.parserConfigs).map((() => {
        var _ref4 = (0, _asyncToGenerator3.default)(function* (parserConfigName) {
          ...
          var query = {
            expression: ['allof', require('./RelayCodegenWatcher').buildWatchExpression(config), ['name', relativeFilePaths, 'wholename']],
            fields: ['exists'],
  ...
  RelayCodegenRunner.prototype.parseEverything = (() => {
    var _ref5 = (0, _asyncToGenerator3.default)(function* (parserName) {
      ...
      var files = yield require('./RelayCodegenWatcher').queryFiles(parserConfig, parserConfig.getFileFilter ? parserConfig.getFileFilter(parserConfig.baseDir) : anyFileFilter);
  ...
  RelayCodegenRunner.prototype.watch = (() => {
    var _ref8 = (0, _asyncToGenerator3.default)(function* (parserName) {
      ...
      yield require('./RelayCodegenWatcher').watchCompile(parserConfig, parserConfig.getFileFilter ? parserConfig.getFileFilter(parserConfig.baseDir) : anyFileFilter, (() => {
